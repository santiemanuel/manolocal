...
const users: Row[] = [
  { id: "client_001", name: "Sofía Ramírez", role: "client", avatar_url: null, city: "Buenos Aires", rating: 4.9 },
  { id: "client_002", name: "Mateo Fernández", role: "client", avatar_url: null, city: "Córdoba", rating: 4.7 },
  { id: "client_003", name: "Valentina Torres", role: "client", avatar_url: null, city: "Rosario", rating: 4.8 },
  { id: "provider_001", name: "Martín Acosta", role: "provider", avatar_url: null, city: "Buenos Aires", rating: 4.9 },
  { id: "provider_002", name: "Camila Ruiz", role: "provider", avatar_url: null, city: "Buenos Aires", rating: 4.8 },
  { id: "provider_003", name: "Nicolás Pereyra", role: "provider", avatar_url: null, city: "La Plata", rating: 4.9 },
  { id: "provider_004", name: "Lucía Benítez", role: "provider", avatar_url: null, city: "Córdoba", rating: 4.6 },
...
const profiles: Row[] = [
  {
    ...
    service_categories: ["plomería", "reparaciones"],
    experience_years: 8,
  ...
  },
  {
    ...
    bio: "Especialista en jardinería urbana y mantenimiento de patios.",
    service_categories: ["jardinería", "mantenimiento"],
    experience_years: 5,
  ...
  },
  {
    ...
    bio: "Técnico electricista para instalaciones domésticas y mejoras simples.",
  ...
  },
  {
    ...
    bio: "Mantenimiento general, colocaciones y reparaciones rápidas.",
...
const jobs: Row[] = [
  ...
  },
  {
    ...
    description: "Corte de césped y limpieza de patio posterior.",
    status: "completed",
    address_area: "Nueva Córdoba",
  ...
  },
  {
    ...
    description: "Reemplazo de toma eléctrica con evidencia de avance y cierre.",
    status: "completed",
    address_area: "Centro",
...
const evidenceSeeds: EvidenceSeed[] = [
  evidenceSeed("evidence_001", "job_001", "provider_001", "before", "job_001_before.png", "Estado inicial de la pérdida bajo la cocina.", "Se observa una pérdida activa debajo de la cocina antes de la reparación.", "valid", "before", 0.93),
  evidenceSeed("evidence_002", "job_001", "provider_001", "after", "job_001_after.png", "Reparación terminada sin pérdida visible.", "La imagen indica una reparación finalizada y sin pérdida visible.", "valid", "work_completed", 0.95),
  evidenceSeed("evidence_003", "job_002", "provider_002", "before", "job_002_before.png", "Patio posterior antes del corte de césped.", "Se observa césped alto y área pendiente de mantenimiento.", "valid", "before", 0.88),
  evidenceSeed("evidence_004", "job_002", "provider_002", "after", "job_002_after.png", "Patio posterior luego del corte de césped.", "Se observa césped recortado y el área despejada.", "valid", "work_completed", 0.91),
  evidenceSeed("evidence_005", "job_003", "provider_003", "progress", "job_003_progress.png", "Avance durante el cambio de toma.", "Se observa trabajo eléctrico en progreso; requiere evidencia final.", "warning", "progress", 0.79, ["trabajo_en_progreso"]),
  evidenceSeed("evidence_006", "job_003", "provider_003", "after", "job_003_after.png", "Toma reemplazada y frente colocado.", "La toma parece instalada y el área de trabajo quedó ordenada.", "valid", "work_completed", 0.87),
...
const reviews: Row[] = [
  ...
  review("review_002", "job_002", "client_002", "provider_002", 5, "El patio quedó prolijo y la evidencia muestra el cambio.", "2026-05-28T13:10:00.000Z"),
  review("review_003", "job_003", "client_003", "provider_003", 4, "Buen trabajo; la primera evidencia mostró avance y luego se completó.", "2026-05-28T13:15:00.000Z"),
  review("review_004", "job_004", "client_001", "provider_004", 5, "El departamento quedó listo para entregar.", "2026-05-28T13:20:00.000Z"),
];
