...
const profiles: Row[] = [
  {
    ...
    service_categories: JSON.stringify(["plomería", "reparaciones"]),
    experience_years: 8,
  ...
  },
  {
    ...
    service_categories: JSON.stringify(["jardinería", "mantenimiento"]),
    experience_years: 5,
...
const jobSeeds: JobSeed[] = [
  jobSeed(
    ...
    "service_plumbing",
    "Pérdida bajo cocina",
    "Reparación de pérdida de agua debajo de la cocina.",
    "Palermo",
  ...
  jobSeed(
    ...
    "service_gardening",
    "Corte de césped",
    "Corte de césped y limpieza de patio posterior.",
    "Nueva Córdoba",
  ...
  jobSeed(
    ...
    "service_electricity",
    "Cambio de toma",
    "Reemplazo de toma eléctrica con evidencia de avance y cierre.",
    "Centro",
...
const evidenceSeeds: EvidenceSeed[] = [
  evidenceSeed("evidence_001", "job_001", "provider_001", "before", "job_001_before.png", "Estado inicial de la pérdida bajo la cocina.", "Se observa una pérdida activa debajo de la cocina antes de la reparación.", "valid"),
  evidenceSeed("evidence_002", "job_001", "provider_001", "after", "job_001_after.png", "Reparación terminada sin pérdida visible.", "La imagen indica una reparación finalizada y sin pérdida visible.", "valid"),
  evidenceSeed("evidence_003", "job_002", "provider_002", "before", "job_002_before.png", "Patio posterior antes del corte de césped.", "Se observa césped alto y área pendiente de mantenimiento.", "valid"),
  evidenceSeed("evidence_004", "job_002", "provider_002", "after", "job_002_after.png", "Patio posterior luego del corte de césped.", "Se observa césped recortado y el área despejada.", "valid"),
  evidenceSeed("evidence_005", "job_003", "provider_003", "progress", "job_003_progress.png", "Avance durante el cambio de toma.", "Se observa trabajo eléctrico en progreso; requiere evidencia final.", "warning"),
  evidenceSeed("evidence_006", "job_003", "provider_003", "after", "job_003_after.png", "Toma reemplazada y frente colocado.", "La toma parece instalada y el área de trabajo quedó ordenada.", "valid"),
...
const reviews: Row[] = [
  ...
  },
  {
    ...
    rating: 5,
    comment: "El patio quedó prolijo y la evidencia muestra el cambio.",
    arkiv_entity_key: null,
    arkiv_tx_hash: null,
  ...
  },
  {
    ...
    rating: 4,
    comment: "Buen trabajo; la primera evidencia mostró avance y luego se completó.",
    arkiv_entity_key: null,
    arkiv_tx_hash: null,
  ...
  },
  {
    ...
    rating: 5,
    comment: "El departamento quedó listo para entregar.",
    arkiv_entity_key: null,
    arkiv_tx_hash: null,
